 ...
 */
@JsonPropertyOrder({
  MessageResponse.JSON_PROPERTY_STATUS,
  MessageResponse.JSON_PROPERTY_MESSAGE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class MessageResponse extends HashMap<String, Object> {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(status, message, super.hashCode(), additionalProperties);
  }
